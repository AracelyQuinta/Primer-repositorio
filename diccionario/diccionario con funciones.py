...
def modificar_datos(informacion_personal):
    ...
    if modificar_ciudad.lower() == "si":  # Si el usuario responde que sí
...
def añadir_datos(informacion_personal):
    ...
    if añadir_datos.lower() == "si":  # Si el usuario responde que sí
...
def saber_si_esta_una_categoria(informacion_personal):
    ...
    if saber_si_esta_una_categoria.lower() == "si":  # Si el usuario responde que sí
...
def eliminar_un_dato(informacion_personal):
    ...
    if dato_a_eliminar.lower() == "si":  # Si el usuario responde que sí
